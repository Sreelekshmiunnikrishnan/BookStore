  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl">BookList</h1>
        ...
        <table className="w-full border-seperate border-spacing-2">
          ...
          <thead>
            <tr>
              ...
              <th  className="border border-slate-600 rounded-md:hidden">PublishYear</th>
              <th  className="border border-slate-600 rounded-md:hidden">Operations</th>
            </tr>
          </thead>
          <tbody>
            {
              ...
              books.map((book,index) =>(
                ...
                <tr>
                  <td col-span="5" className="border border-slate-700 rounded-md text-center">
                    No books available
                  </td>
                </tr>
              )
